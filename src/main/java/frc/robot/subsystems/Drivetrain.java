...
public class Drivetrain extends SubsystemBase {
  ...
  private DifferentialDriveOdometry m_odometry = new DifferentialDriveOdometry(new Rotation2d(), 0, 0); //left distance meters, right distance meters
  ...
  private WPI_PigeonIMU pigeon = new WPI_PigeonIMU(m_leftSRX);
